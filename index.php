...
$result= mysql_query("select * from products where product_type='Smartphones' and product_brand='Samsung' order by product_id DESC") or die (mysql_error());
...
?>
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tab">
						...
						<br />
									...
									<center>		
										<span class="prices">
											Rs.<?php $oprice=$row['product_price']; echo formatMoney($oprice, true);?>
										</span>									
						<br />
						<br />
