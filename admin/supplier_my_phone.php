...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="supplier_my_phone.php"><font color="#000000">Myphone</a></font></li>
  </ul>
</div></caption>
...
<tbody>
<?php
$result= mysql_query("select * from suppliers where supplier_company_name='Myphone' ") or die (mysql_error());
