...
<?php
	include('includes/db.php');
							...
							if ($error > 0){
									...
									mySQL_query("INSERT INTO products (product_name,product_brand,product_type,product_description,product_price,supplier,product_status,date_added,location) 
									VALUES ('$product_name','$product_brand','$product_type','$product_description','$product_price','$supplier','$product_status',NOW(),'$location')") or die(mysql_error());
									}
...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="cherry_mobile.php"><font color="#000000">Cherry Mobile</font></a></li>
...
$result= mysql_query("select * from products where product_brand='Cherry Mobile' ") or die (mysql_error());
while ($row= mysql_fetch_array ($result) ){
$id=$row['product_id'];
?>
