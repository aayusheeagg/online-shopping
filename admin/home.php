...
<p style="margin-left:1px; font-size:15px;"><?php include ('fulldate.php'); ?></p>
	...
	<p>
	Innotech is a company of effectiveness and efficiency when it comes
	...
	<p>
	Innotech is a business oriented institution, aiming to govern the 
...
<br />
	...
	<h3 style="color:#0000ff; text-indent:20px;">Objectives</h3>
		<ul>
			<li style="line-height:35px;">To Improve Innotech&#8217;s customer handling in huge amount and in different locations.</li>
			<li style="line-height:35px;">Allows Innotech to promote any of their product.</li>
			<li style="line-height:35px;">To make Innotech&#8217;s Sales go high.</li>
		</ul>
	</div>
</div>	
