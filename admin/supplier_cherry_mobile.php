...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="supplier_cherry_mobile.php"><font color="#000000">Cherry Mobile</font></a></li>
...
<tbody>
<?php
$result= mysql_query("select * from suppliers where supplier_company_name='Cherry Mobile' ") or die (mysql_error());
