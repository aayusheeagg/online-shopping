...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="my_phone.php"><font color="#000000">Myphone</a></font></li>
  </ul>
</div></caption>
...
$result= mysql_query("select * from products where product_brand='Myphone' ") or die (mysql_error());
while ($row= mysql_fetch_array ($result) ){
$id=$row['product_id'];
?>
